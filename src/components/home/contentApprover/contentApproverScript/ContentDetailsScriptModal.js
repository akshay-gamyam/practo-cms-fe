...
import { formatDate, getContentPreview, getStatusBadge, getWordCount } from '../../../../utils/helper';
    ...
    >
      <div className="space-y-6">
        ...
        {type === 'script' && (
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-900 mt-1">Version {content.version || 1}</p>
            </div>
            <div>
        ...
        {type === 'script' && content.content && (
          <div>
            <label className="text-sm font-medium text-gray-500 block mb-2">Content Preview</label>
